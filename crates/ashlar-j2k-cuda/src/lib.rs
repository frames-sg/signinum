...
//! CUDA-facing device-output adapter for `ashlar-j2k`.
//!
...
pub enum Error {
    ...
    #[error("backend request {request:?} is not supported by ashlar-j2k-cuda")]
...
impl Codec {
    fn decode_tile_to_surface_impl(
        ctx: &mut ashlar_core::DecoderContext<CpuJ2kContext>,
...
pub use ashlar_j2k::{J2kContext, J2kScratchPool};
