...
pub enum Error {
    ...
    #[error("backend request {request:?} is not supported by ashlar-jpeg-metal")]
...
pub use ashlar_jpeg::{Info, Rect as JpegRectPublic};

#[cfg(test)]
mod tests {
    use super::*;
    use ashlar_jpeg::adapter::{build_metal_fast420_packet, build_metal_fast444_packet};
