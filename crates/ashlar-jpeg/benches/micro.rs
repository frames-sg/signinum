...
fn bench_micro(c: &mut Criterion) {
    ...
    c.bench_function("micro/inspect_small", |b| {
        b.iter(|| {
            let info = Decoder::inspect(small).expect("ashlar inspect");
    ...
    {
        use ashlar_jpeg::bench_support::bench_idct_reference_block_with;
    ...
    {
        use ashlar_jpeg::bench_support::bench_idct_reduced_2x2_block_with;
    ...
    {
        use ashlar_jpeg::bench_support::bench_idct_neon_block;
    ...
    #[cfg(target_arch = "x86_64")]
    {
        if std::is_x86_feature_detected!("avx2") {
            use ashlar_jpeg::bench_support::bench_idct_avx2_block;
