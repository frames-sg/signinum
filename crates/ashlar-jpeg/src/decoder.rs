...
///
/// ```no_run
/// use ashlar_jpeg::{decode_tile_into, PixelFormat, ScratchPool};
///
...
fn core_info(info: &Info) -> ashlar_core::Info {
    ashlar_core::Info {
...
fn core_rect(rect: Rect) -> ashlar_core::Rect {
    ashlar_core::Rect {
        x: rect.x,
        y: rect.y,
        w: rect.w,
...
fn jpeg_rect(rect: ashlar_core::Rect) -> Rect {
    Rect {
        x: rect.x,
        y: rect.y,
        w: rect.w,
